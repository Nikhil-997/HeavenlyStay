...
<body>
		...
		<div class="row">
			...
			<div class="col-md-2 stacked">
				...
				<div class="nav nav-pills nav-stacked">
					...
					<li><a id="add-room1-form.php" class="adash">Add Room</a></li>
					<li><a id="view-room.php" class="adash">View Room</a></li>
					<li><a id="View-Cust-feedback.php" class="adash">View Customer Feedback</a></li>
					<li><a id="add-branch-form.php" class="adash">Add Branch</a></li>
				
					<!--<li><a id="add-service-form.php" class="adash">Add Event Hall</a></li>-->
					<li><a id="view-Room-Confirmation.php" class="adash">View Room Confirmation</a></li>
					<li><a id="view-service-booking.php" class="adash">View Service Confirmation</a></li>
					<li><a id="view-Hea-Spa.php" class="adash">View Gym And Pool</a>
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:380px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
            <div>
                <img data-u="image" src="img/36820961.jpg" />
                <div u="thumb"></div>
            </div>
            <div>
                <img data-u="image" src="img/HD-918-BEDROOM.jpg" />
                <div u="thumb"></div>
            </div>
            <div>
                <img data-u="image" src="img/602237.jpg" />
                <div u="thumb"></div>
            </div>
            <div>
            ...
            <div>
                <img data-u="image" src="img/195316.jpg" />
                <div u="thumb"></div>
            </div>
