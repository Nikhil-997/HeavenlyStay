...
<body>
                ...
                <div class="container">
                    <h1 class="navbar">
                        <a href="index.php" title="Heavenly Stay">
                            <!--<img src="images/heavenlystay.png" alt="Heavenly Stay" />-->
                        </a>
                    </h1>
    ...
    <h2 style="color: white; opacity: .75; font-size: 3rem; display: flex; justify-content: left; align-items: left; height: 100%;">HEAVENLY STAY SIGN UP</h2>
  </div>
        <div id="slideshow">
            <div class="fullwidthbanner-container">
			<form action="registration-q.php" method="post">
        <!-- <label class="form-input">-->
		
	  
       
        <input type="text" autofocus="true"  placeholder="Full Name"required name="Name" /><br>
     ...
     <!-- <label class="form-input">-->
        ...
        <input type="text"  placeholder="Address" required  name="Address" /><br><br>
		<input type="radio" name="Gender" value="Male" required />Male
		   <input type="radio" name="Gender" value="Female" required />Female	<br><br>
		 <input type="date"  placeholder="Date Of Birth" required name="DOB" /><br><br>
		 <input type="text"  placeholder="Phone No" required  name="Phoneno"/><br><br>
		  <input type="text"  placeholder="Email Id" required name="EmailID" /><br><br>
		   <input type="text" autofocus="true"  placeholder="Username"required name="Username" /><br><br>
      ...
      <div class="submit-container clearfix" style="margin-top: 2rem;">          
        <input type="Submit" role="button" name="Submit" class="btn btn-irenic float-left" tabindex="0" value="Sign Up">
         <!-- <span>LOGIN</span>-->
        </div>
       ...
       <!-- <div class="login-pending">
          ...
          <div class="login-granted-content">
			...
			<!--<form action="authorizeusercheck-q.php" method="post">
			<b><h3>Username : <input type="text" name="Username" ></h3></b><br>
			<b><h3>Password : <input type="Password" name="Password" ></h3></b><br>
			<b><h3><input type="submit" name="submit"></h3></b><br>
			</form>
                    ...
                    <ul>    <!-- SLIDE  -->
                        <!-- Slide1 -->
                          <!-- <li data-transition="zoomin" data-slotamount="7" data-masterspeed="1500">
                            <!-- MAIN IMAGE -->
                            <!--<img src="images/resort3.png" alt="resort">
                        </li>   -->
                            <!--<img src="images/resort2.png" alt="swimming pool">
                       <!-- </li>
                        
                        <!-- Slide3 -->
                        <!--<li data-transition="slidedown" data-slotamount="7" data-masterspeed="1500">
                            <!-- MAIN IMAGE -->
                            <!--<img src="images/resort4.png" alt="room">
                        </li>
                    </ul>
                </div>-->
            </div>
